    ...
    <BrowserRouter>
      ...
      <nav className="navbar">
        ...
        <div className="logo-container">
          <span className="logo-name">🛒 Fresh Cart</span>
        </div>
        ...
        <div className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          <Link to="/veg" className="nav-link" onClick={() => setMenuOpen(false)}>
            🥕 Veg
          </Link>

          <Link to="/nonveg" className="nav-link" onClick={() => setMenuOpen(false)}>
            🍗 Non-Veg
          </Link>

          <Link to="/milk" className="nav-link" onClick={() => setMenuOpen(false)}>
            🥛 Milk
          </Link>
